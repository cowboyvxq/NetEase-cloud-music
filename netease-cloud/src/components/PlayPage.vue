    ...
    <div class="model">
      ...
      >
          <div class="lyrcolor" v-show='showcolor'>
            <span @click="active = true,pink=false,white=false,judge=false"></span>
            <span @click="judge = true,pink=false,white=false"></span>
